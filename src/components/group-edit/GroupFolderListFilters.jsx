...
import styles from './GroupFolderListFilters.module.css';

const GroupFolderListFilters = ({ search, sortBy, setSearch, setSortBy }) => {
...
export default GroupFolderListFilters;
